...
module.exports = function () {
	...
	_helpers.cloudinaryUrl = function (context, options) {
		...
		if ((context) && (context.public_id)) {
			...
			console.log('Calling cloudinary with:', imageName, options);
			var a = cloudinary.url(imageName, options.hash).replace('dfjtnd0ht-res.cloudinary.com', 'res.cloudinary.com/dfjtnd0ht');
	...
	* */
	...
	_helpers.ifOdd = function (v1, options) {
		if (v1 % 2 === 1) {
			return options.fn(this);
		}
		return options.inverse(this);
	...
	_helpers.ifEven = function (v1, options) {
		if (v1 % 2 === 0) {
			return options.fn(this);
		}
		return options.inverse(this);
